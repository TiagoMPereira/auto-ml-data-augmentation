...
for id in ${datasets[@]}; do
    ...
    python3 ./automl_autogluon.py $id
    ...
    # python3 -m pip install --upgrade pip
    # python3 -m pip install --upgrade setuptools pytictoc wheel git+https://github.com/keras-team/keras-tuner.git scikit-learn autokeras
    # python3 ./automl_autokeras.py $id
    ...
    # python3 -m pip install --upgrade pip
    # python3 -m pip install --upgrade setuptools pytictoc wheel swig torch torchvision torchaudio --extra-index-url https://download.pytorch.org/whl/cpu autoPyTorch
    # python3 ./automl_autopytorch.py $id
    ...
    # python3 -m pip install --upgrade pip
    # python3 -m pip install --upgrade setuptools pytictoc wheel auto-sklearn
    # python3 ./automl_autosklearn.py $id
    ...
    # python3 -m pip install --upgrade pip
    # python3 -m pip install --upgrade setuptools pytictoc wheel evalml
    ...
    # python3 -m pip install --upgrade pip
    # python3 -m pip install --upgrade setuptools pytictoc wheel flaml
    ...
    # python3 -m pip install --upgrade pip
    # python3 -m pip install --upgrade setuptools pytictoc wheel gama
    ...
    # python3 -m pip install --upgrade pip
    # python3 -m pip install --upgrade setuptools pytictoc wheel requests tabulate future scikit-learn pandas h2o
    ...
    # python3 -m pip install --upgrade pip
    # python3 -m pip install --upgrade setuptools pytictoc wheel lightautoml
    ...
    # python3 -m pip install --upgrade pip
    # python3 -m pip install --upgrade setuptools pytictoc wheel deap update_checker tqdm stopit xgboost torch tpot
    ...
    # python3 -m pip install --upgrade pip
    # python3 -m pip install --upgrade setuptools pytictoc wheel scikit-learn matplotlib pandas tabulate openpyxl
